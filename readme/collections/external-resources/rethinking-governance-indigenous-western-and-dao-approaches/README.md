...
Shared meaning, legitimacy, moral limits.

This layer includes the cultural, ethical, and relational foundations that make political authority and economic arrangements intelligible and legitimate.
{% endstep %}

{% step %}
### Political

Authority, law, collective decision-making.

This layer comprises formal institutions, rights, representation, and mechanisms for collective decision-making.
{% endstep %}

{% step %}
### Economic

Circulation, incentives, exchange.

This layer covers markets, incentives, resource flows, and economic mechanisms that enable coordination and provisioning.
{% endstep %}
{% endstepper %}
